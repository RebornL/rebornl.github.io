...
![](https://raw.githubusercontent.com/RebornL/picbed/master//maopao.gif)
...
![](https://raw.githubusercontent.com/RebornL/picbed/master//select.gif)
...
![](https://raw.githubusercontent.com/RebornL/picbed/master//insert.gif) 
...
![](https://raw.githubusercontent.com/RebornL/picbed/master//shell.gif)
...
![](https://raw.githubusercontent.com/RebornL/picbed/master//merge.gif)
...
![](https://raw.githubusercontent.com/RebornL/picbed/master//quick.gif)
...
堆排序涉及到**堆**这个概念，堆的结点值总是大于等于其子节点，而且堆是一颗完全二叉树。因此堆可以用数组来表示，假设数组下标从1开始，那么位置为`k`的元素的父节点的位置为`k/2`，其子节点的位置分别为`2K`和`2k+1`。堆排序的插入和删除操作的展示图，可以看[这篇文章](<https://blog.csdn.net/zdp072/article/details/44227317>)
