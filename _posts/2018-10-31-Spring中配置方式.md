...
![spring4.0](https://blog.raymondtech.top/img/springkuangjia.png)
...
![scope](https://blog.raymondtech.top/img/scope-property.png)
...
以上的xml配置，均为显示注入依赖，Beans还可以通过指定bean的autowire属性为一个bean定义一个自动装配的模式：![beans模式](https://blog.raymondtech.top/img/bean-way.png)
...
整体框架围绕DispatcherServlet设计，![1554684539358](../img/1554684539358.png)
