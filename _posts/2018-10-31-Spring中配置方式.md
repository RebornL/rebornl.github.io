...
![spring4.0](https://blog.raymontech.top/img/springkuangjia.png)
...
![bean](.https://blog.raymontech.top/img/bean-property.png)
...
![scope](https://blog.raymontech.top/img/scope-property.png)
...
以上的xml配置，均为显示注入依赖，Beans还可以通过指定bean的autowire属性为一个bean定义一个自动装配的模式：![beans模式](https://blog.raymontech.top/img/bean-way.png)
