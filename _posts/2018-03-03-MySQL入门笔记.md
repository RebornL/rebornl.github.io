...
输出结果：![select1](https://blog.raymontech.top/img/select1.png)
...
输出结果：![select2](https://blog.raymontech.top/img/select2.png)
...
输出结果：![distinct1](https://blog.raymontech.top/img/distinct1.png)
...
```
输出结果：![limit1](https://blog.raymontech.top/img/limit1.png)
...
```
输出结果：![order1](https://blog.raymontech.top/img/order1.png), ![order2](https://blog.raymontech.top/img/order2.png)
...
输出结果：![](https://blog.raymontech.top/img/where1.png)

```mysql
SELECT prod_name, prod_price FROM prod_table WHERE prod_name = 'fuses';
```

输出结果：![](https://blog.raymontech.top/img/where2.png)
...
输出结果：![](https://blog.raymontech.top/img/between1.png)
...
取值写在括号，用‘,’分开，输出结果(获取生产产商为1002，1003，1004的所有商品)：![](https://blog.raymontech.top/img/in1.png)
...
输出结果：![](https://blog.raymontech.top/img/and1.png)
...
输出结果：![](https://blog.raymontech.top/img/or1.png)
...
选取厂商id不为1002，1003的所有商品，输出结果：![](https://blog.raymontech.top/img/not1.png)
...
输出email值为null的厂商：![](https://blog.raymontech.top/img/null1.png)
...
输出结果：![](https://blog.raymontech.top/img/like1.png)

```mysql
SELECT prod_id, prod_name FROM prod_table WHERE prod_name LIKE '% ton anvil';
```

输出结果：![](https://blog.raymontech.top/img/like2.png)
