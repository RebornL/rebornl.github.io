...
输出结果：![select1](https://raw.githubusercontent.com/RebornL/picbed/master/select1.png)
...
输出结果：![select2](https://raw.githubusercontent.com/RebornL/picbed/master/select2.png)
...
输出结果：![distinct1](https://raw.githubusercontent.com/RebornL/picbed/master/distinct1.png)
...
```
输出结果：![limit1](https://raw.githubusercontent.com/RebornL/picbed/master/limit1.png)
...
```
输出结果：![order1](https://raw.githubusercontent.com/RebornL/picbed/master/order1.png), ![order2](https://raw.githubusercontent.com/RebornL/picbed/master/order2.png)
...
输出结果：![](https://raw.githubusercontent.com/RebornL/picbed/master/where1.png)

```mysql
SELECT prod_name, prod_price FROM prod_table WHERE prod_name = 'fuses';
```

输出结果：![](https://raw.githubusercontent.com/RebornL/picbed/master/where2.png)
...
输出结果：![](https://raw.githubusercontent.com/RebornL/picbed/master/between1.png)
...
取值写在括号，用‘,’分开，输出结果(获取生产产商为1002，1003，1004的所有商品)：![](https://raw.githubusercontent.com/RebornL/picbed/master/in1.png)
...
输出结果：![](https://raw.githubusercontent.com/RebornL/picbed/master/and1.png)
...
输出结果：![](https://raw.githubusercontent.com/RebornL/picbed/master/or1.png)
...
选取厂商id不为1002，1003的所有商品，输出结果：![](https://raw.githubusercontent.com/RebornL/picbed/master/not1.png)
...
输出email值为null的厂商：![](https://raw.githubusercontent.com/RebornL/picbed/master/null1.png)
...
输出结果：![](https://raw.githubusercontent.com/RebornL/picbed/master/like1.png)

```mysql
SELECT prod_id, prod_name FROM prod_table WHERE prod_name LIKE '% ton anvil';
```

输出结果：![](https://raw.githubusercontent.com/RebornL/picbed/master/like2.png)
