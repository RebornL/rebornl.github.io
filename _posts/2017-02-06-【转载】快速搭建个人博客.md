...
date:       2017-02-06
author:     BY
header-img: https://blog.raymondtech.top/img/post-bg-re-vs-ng2.jpg
catalog: true
tags:
    - Blog
---
...
header-img: https://blog.raymondtech.top/img/post-bg-rwd.jpg  	#显示在首页的背景图片
email: You@gmail.com	
...
sidebar-avatar:/https://blog.raymondtech.top/img/avatar-by.JPG      # 你的个人头像 这里你可以改成我在img文件夹中的两张备用照片 https://blog.raymondtech.top/img/avatar-m 或 avatar-g
```
#### 社交账号
展示你的其他社交平台
...
date:       2017-02-06 				# 时间
author:     BY 						# 作者
header-img: https://blog.raymondtech.top/img/post-bg-2015.jpg 	#这篇文章标题背景图片
catalog: true 						# 是否归档
tags:								#标签
    - 生活
---
