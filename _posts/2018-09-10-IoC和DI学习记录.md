...
![resource-lambda](https://blog.raymondtech.top/img/resource-lambda.png)
...
![ClassPathXmlApplicationContext](https://blog.raymondtech.top/img/ClassPathXmlApplicationContext.png)
...
![](https://blog.raymondtech.top/img/bean-lifecircle.png)

![](https://blog.raymondtech.top/img/bean-lifecircle2.png)



#### spring容器，Bean配置信息，Bean实现类及应用程序的关系

![](https://blog.raymondtech.top/img/springAndBean.png)
...
![](https://blog.raymondtech.top/img/ioc-waterline.png)
...
Spring AOP基于**代理**（Proxying），而AspectJ基于**字节码操作**（Bytecode Manipulation）。
